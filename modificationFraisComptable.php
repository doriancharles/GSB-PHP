...
<html>
	...
	<form name="formulaire6" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	...
	?>
	<ul>
		<button onclick="window.location.href = 'http://localhost/gsb/src/vues/suppressionFraisComptable.php';">Supprimer un frais hors forfait</button>
	</ul>
	<ul>
