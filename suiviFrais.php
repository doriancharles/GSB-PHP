...
<html>
	...
	<fieldset>
		...
		<form name="form10" method="post">
			...
			<ul>
			<?php echo "P.S : Ne mettre que l'ID montrera le résultat du mois courant" ?>
			</ul>
		</form>
		<body style="background-color:#606060;">
			<table>
	...
	<ul>
		<button onclick="window.location.href = 'http://localhost/gsb/src/vues/mettreEnPaiement.php';">Mettre en paiement une fiche de frais</button>
	</ul>
	<ul>
